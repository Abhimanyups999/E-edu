...
app = Flask(__name__)
app.secret_key="abc"
path1=r"C:\Users\HP\PycharmProjects\e-edu\static\student_photos\\"
path=r"C:\Users\HP\PycharmProjects\e-edu\static\staff_photos\\"
path2=r"C:\Users\HP\PycharmProjects\e-edu\static\syllabus\\"
path3=r"C:\Users\HP\PycharmProjects\e-edu\static\notes\\"
path4=r"C:\Users\HP\PycharmProjects\e-edu\static\qp\\"
...
def add_staff():
    if session['lg'] == 'lin':
        if request.method =="POST":
            ...
            db.insert("insert into staff VALUES ('"+str(q)+"','"+staff_name+"','"+gender+"','"+place+"','"+email+"','"+str(staff_photo)+"','"+post+"','"+pin+"','"+qualification+"','"+dept+"','"+mobile_number+"')")
            import smtplib
    ...
    if session['lg'] == 'lin':
        if request.method =="POST":
            ...
            if request.files!=None:
                if photo.filename!="":
                    db.update( "update staff set staff_name ='" + staff_name + "',dept_id='" + dept + "',staff_mob='" + mobile_number + "',photo='" + str(staff_photo) + "',staff_gender='" + gender + "',staff_post='" + post + "',staff_pin='" + pin + "',staff_qualification='" + qualification + "',dept_id='" + dept + "',staff_place='" + place + "'where staff_id='" + sid + "'")
                    return '<script> alert("updated sucessfully");window.location = "/view_staff"</script>'
                else:
                    db.update( "update staff set staff_name ='" + staff_name + "',dept_id='" + dept + "',staff_mob='" + mobile_number + "',staff_gender='" + gender + "',staff_post='" + post + "',staff_pin='" + pin + "',staff_qualification='" + qualification + "',dept_id='" + dept + "',staff_place='" + place + "'where staff_id='" + sid + "'")
                    return '<script> alert("updated sucessfully");window.location = "/view_staff"</script>'
            else:
                db.update( "update staff set staff_name ='" + staff_name + "',dept_id='" + dept + "',staff_mob='" + mobile_number + "',staff_gender='" + gender + "',staff_post='" + post + "',staff_pin='" + pin + "',staff_qualification='" + qualification + "',dept_id='" + dept + "',staff_place='" + place + "'where staff_id='" + sid + "'")
                return '<script> alert("updated sucessfully");window.location = "/view_staff"</script>'
...
def add_student():
    if session['lg'] == 'lin':
        if request.method =="POST":
            ...
            db.insert("insert into student VALUES ('"+str(q)+"','"+student_name+"','"+gender+"','"+student_place+"','"+student_post+"','"+student_pin+"','"+course_id+"','"+email+"','"+student_semester+"','"+student_batch+"','"+student_mob_no+"','"+Reg_no+"','"+str(pp)+"')")
            import smtplib
...
def update_student(sid):
    if session['lg'] == 'lin':
        if request.method =="POST":
            ...
            if request.files!=None:
                if photo.filename!="":
                    db.update("update student set stud_name = '"+student_name+"',stud_gender ='"+gender+"',stud_place ='"+student_place+"',stud_post='"+student_post+"',stud_pin='"+student_pin+"',stud_course_id='"+course_id+"',semester='"+student_semester+"',batch='"+student_batch+"',stud_mob='"+student_mob_no+"',photo='"+str(pp)+"' where stud_id='"+sid+"'")
                    return '<script> alert("updated sucessfully");window.location = "/view_student#aaa"</script>'
                else:
                    db.update("update student set stud_name = '" + student_name + "',stud_gender ='" + gender + "',stud_place ='" + student_place + "',stud_post='" + student_post + "',stud_pin='" + student_pin + "',stud_course_id='" + course_id + "',stud_email='" + email + "',semester='" + student_semester + "',batch='" + student_batch + "',stud_mob='" + student_mob_no + "' where stud_id='"+sid+"'")
                    return '<script> alert("updated sucessfully");window.location = "/view_student#aaa"</script>'
            else:
                 db.update("update student set stud_name = '" + student_name + "',stud_gender ='" + gender + "',stud_place ='" + student_place + "',stud_post='" + student_post + "',stud_pin='" + student_pin + "',stud_course_id='" + course_id + "',stud_email='" + email + "',semester='" + student_semester + "',batch='" + student_batch + "',stud_mob='" + student_mob_no + "' where stud_id='"+sid+"'")
            return '<script> alert("updated sucessfully");window.location = "/view_student#aaa"</script>'
...
def add_course():
    if session['lg'] == 'lin':
        if request.method == "POST":
            ...
            db = Db()
            qry = db.selectOne("select * from course where dept_id = '"+department_name+"' and course_name = '"+course_name+"' and sem ='"+semester+"' ")
            if qry is not None:
                return '<script> alert("Already Exist ");window.location = "/add_course"</script>'
            db.insert("insert into course VALUES ('','"+course_name+"','"+department_name+"','"+semester+"')")
            return '<script> alert("added sucessfully");window.location = "/admin_home"</script>'
        else:
            db =Db()
            a = db.select("select * from department")
...
def complaint_reply(cid):
    if session['lg'] == 'lin':
        if request.method == "POST":
            ...
            db = Db()
            db.update("update complaint set reply='"+send_reply+"',reply_date=curdate() where complaint_id='"+cid+"'")
            return '<script>alert("added sucessfully");window.location = "/admin_home"</script>'
        else:
...
def course_allocation():
    if session['lg'] == 'lin':
        if request.method=="POST":
            ...
            db= Db()
            qry = db.selectOne("select * from suballocatecourse  where course_id = '"+course_name+"' and sems = '"+semester+"' and subject_id = '"+subject_name+"'")
            if qry is not None:
                return '<script> alert("Already Exist ");window.location = "/course_allocation"</script>'

            db.insert("insert into suballocatecourse VALUES ('','"+course_name+"','"+subject_name+"','"+semester+"')")
            return '<script> alert("added sucessfully");window.location = "/admin_home"</script>'
        else:
            db = Db()
...
def alloc_staff(aid,did):
    ...
    if request.method == 'POST':
        ...
        db =Db()
        res = db.select("select * from staff,department where staff.dept_id =department.dept_id and staff.dept_id = '"+did+"'")
...
def update_course_allocation(aid):
    if session['lg'] == 'lin':
        if request.method=="POST":
            ...
            semester = request.form['select3']
            db= Db()
            db.update("update suballocatecourse set course_id='"+course_name+"',subject_id='"+subject_name+"',sems='"+semester+"' where suballoc_courseid='"+aid+"'")
...
def staff_view():
    if session['lg'] == 'lin':
        ...
        db= Db()
        res =db.selectOne("select * from department,staff WHERE department.dept_id = staff.dept_id and staff.staff_id ='"+str(session['lid'])+"'")
...
def allocated_subject():
    if session['lg'] == 'lin':
        db= Db()
        res = db.select("select * from subject_alloc,suballocatecourse,subject where suballocatecourse.suballoc_courseid = subject_alloc.suballoccourseid and suballocatecourse.subject_id = subject.sub_id and subject_alloc.staff_id ='"+str(session['lid'])+"'")
...
def attendence(cid,sem,c):
    if request.method == 'POST':
        ...
        if len(qry)>0:
            ...
            for i in sid2:
                if i in sid:
                    ...
                    db.insert("insert into attendence VALUES ('','"+str(i)+"','present',curdate(),'"+str(cid)+"')")
                    # return '''<script> alert('added sucessfully'); window.location="/allocated_subjects"</script>'''
                else:

                    db.insert("insert into attendence VALUES ('','"+str(i)+"','absent',curdate(),'"+str(cid)+"')")
        ...
        res = db.select("select * from student  where semester ='" + str(sem) + "' and stud_course_id= '" + str(c) + "'")
...
def attendence_view():
    if request.method=="POST":
        d=request.form['d']
        db=Db()
        res = db.select("select * from attendence,student,class,subject_alloc,suballocatecourse,subject where attendence.student_id=student.stud_id and attendence.class_id=class.cid and class.subject_alloc_id=subject_alloc.suballoc_courseid and subject_alloc.suballoccourseid=suballocatecourse.suballoc_courseid and suballocatecourse.subject_id=subject.sub_id and subject_alloc.staff_id='" + str(session['lid']) + "' and attendence.attendence_date='"+d+"'")
        ...
        res=db.select("select * from attendence,student,class,subject_alloc,suballocatecourse,subject where attendence.student_id=student.stud_id and attendence.class_id=class.cid and class.subject_alloc_id=subject_alloc.suballoc_courseid and subject_alloc.suballoccourseid=suballocatecourse.suballoc_courseid and suballocatecourse.subject_id=subject.sub_id and subject_alloc.staff_id='"+str(session['lid'])+"'")
...
def class_schedule():
    if session['lg'] == 'lin':
        if request.method == 'POST':
            ...
            db = Db()
            res = db.select("select sub_name,subject_alloc.suballoc_courseid from subject,suballocatecourse,subject_alloc where subject.sub_id=suballocatecourse.subject_id and suballocatecourse.suballoc_courseid=subject_alloc.suballoccourseid and staff_id='"+str(session['lid'])+"'")
            print(res)
...
def class_schedule_view():
    if session['lg'] == 'lin':
        db = Db()
        res = db.select("select * from subject,suballocatecourse,class,subject_alloc where subject.sub_id = suballocatecourse.subject_id and class.subject_alloc_id = subject_alloc.suballoc_courseid and subject_alloc.staff_id='"+str(session['lid'])+"' and suballocatecourse.suballoc_courseid=subject_alloc.suballoccourseid")
...
def class_schedule_edit(aid):
    if session['lg'] == 'lin':
        if request.method == 'POST':
            ...
            db.update("update class  set subject_alloc_id ='"+subject+"',time='"+time+"',date='"+date+"' where cid='"+aid+"'")
            print("update class  set subject_alloc_id ='"+subject+"',time='"+time+"',date='"+date+"' where cid='"+aid+"'")
            return '<script> alert("updated sucessfully");window.location = "/staff_home"</script>'
        else:

            db = Db()
            res = db.select("select * from subject,suballocatecourse,subject_alloc where subject.sub_id=suballocatecourse.subject_id and suballocatecourse.suballoc_courseid=subject_alloc.suballoccourseid and staff_id='"+str(session['lid'])+"'")
            print(res,"eeeeeeeeeeeee")
            res1 = db.selectOne("select * from class, subject_alloc where class.subject_alloc_id = subject_alloc.suballoc_courseid and class.cid ='"+aid+"'")
...
def mayor_mayor_councillor_chat():
        ...
        a=session['lid']
        db=Db()
        res = db.select("select * from student  where semester ='" + str(session['s']) + "' and stud_course_id= '" + str(session['cid']) + "'")
...
def chatsnd():
    # if session['lg'] == "lin":
        ...
        db=Db()
        q2="insert into disscussion(from_id,to_id,message,date) values('"+str(c)+"','"+str(b)+"','"+m+"',curdate())"
        res=db.insert(q2)
        v = {}
        if int(res) > 0:
            v["status"] = "ok"
...
def Exam_schedule():
    if session['lg'] == "lin":
        if request.method=="POST":
            ...
            db = Db()
            q=db.selectOne("select * from exam where subject_alloc_id='"+subject+"' and date='"+date+"' and time='"+time+"' and marks='"+m+"'")
            if q is None:
            ...
            db=Db()
            q=db.select("select * from subject,suballocatecourse,subject_alloc,course where course.course_id=suballocatecourse.course_id and suballocatecourse.subject_id=subject.sub_id and subject_alloc.staff_id='"+str(session['lid'])+"' and subject_alloc.suballoccourseid=suballocatecourse.suballoc_courseid")
...
def viewexamschedule():
    ...
    if session['lg'] == "lin":
        if request.method == 'POST':
            res = db.select("select * from subject,suballocatecourse,subject_alloc,course,exam where course.course_id=suballocatecourse.course_id and suballocatecourse.subject_id=subject.sub_id and subject_alloc.staff_id='"+str(session['lid'])+"' and subject_alloc.suballoccourseid=suballocatecourse.suballoc_courseid and exam.subject_alloc_id=subject_alloc.suballoc_courseid and exam.date='"+request.form['d']+"'")
            d = datetime.datetime.now().strftime("%Y-%m-%d")
            return render_template('staff/Exam_view.html', data=res, d=d)
        res = db.select("select * from subject,suballocatecourse,subject_alloc,course,exam where course.course_id=suballocatecourse.course_id and suballocatecourse.subject_id=subject.sub_id and subject_alloc.staff_id='"+str(session['lid'])+"' and subject_alloc.suballoccourseid=suballocatecourse.suballoc_courseid and exam.subject_alloc_id=subject_alloc.suballoc_courseid")
        d = datetime.datetime.now().strftime("%Y-%m-%d")
        print(str(d))
        dd=str(d)
        return render_template('staff/Exam_view.html', data=res,d=d)
...
def quedelete(i):
    ...
    if session['lg'] == "lin":
        ...
        return '''<script>alert('deleted successfully');window.location="/view_question/'''+str(session['qid'])+'''"</script>'''
    return redirect('/')
...
def viewres(eid,cid):
    ...
    if session['lg'] == "lin":
        ...
        q=db.select("select * from student left join result on student.stud_id=result.studid and result.examid='"+str(eid)+"' where student.stud_course_id='"+str(cid)+"' ")
...
def student_profile():
    if session['lg'] == "lin":
        db = Db()
        res = db.selectOne("select * from student,course where student.stud_course_id =course.course_id and stud_id ='" + str(session['lid']) + "'")
...
def subjects_view():
    if session['lg'] == "lin":
        db =Db()
        res = db.select("select course.course_name,subject.sub_name,suballocatecourse.suballoc_courseid,subject_alloc.suballoc_courseid,subject_alloc.suballoccourseid as s  from suballocatecourse join course on suballocatecourse.course_id=course.course_id join `subject` on suballocatecourse.subject_id=subject.sub_id  join subject_alloc on subject_alloc.suballoccourseid=suballocatecourse.suballoc_courseid where  suballocatecourse.course_id= '"+str(session['course_id'])+"' ")
...
def notes_download():
    if session['lg'] == "lin":
        if request.method =="POST":
            ...
            db =Db()
            res = db.select("select * from subject")
            res1 = db.select("select * from studymaterials,subject where studymaterials.subject_id = subject.sub_id and subject.sub_id='"+sub+"' ")
...
def question_paper_download():
    if session['lg'] == "lin":
        if request.method == "POST":
            ...
            db = Db()
            res = db.select("select * from subject")
            res1 = db.select("select * from previous_qp,subject where previous_qp.subid = subject.sub_id and subject.sub_id = '" + sub + "' ")
...
def send_ratings_and_review():
    if session['lg'] == "lin":
        if request.method == "POST":
            ...
            db =Db()
            db.insert("insert into review VALUES ('','"+str(session['lid'])+"','"+rt+"','"+review+"',curdate())")
            return '<script> alert("added sucessfully");window.location = "/student_home"</script>'
...
def suggestion():
    if session['lg'] == "lin":
        if request.method == "POST":
            ...
            db =Db()
            db.insert("insert into suggestions VALUES ('','"+str(session['lid'])+"','"+suggestion+"',curdate())")
            return '<script> alert("added sucessfully");window.location = "/student_home"</script>'
...
def mayor_mayor_councillor_chat1():
    if session['lg'] == "lin":
            a=session['lid']
            db=Db()
            res = db.select("select * from suballocatecourse,subject_alloc,staff where suballocatecourse.suballoc_courseid=subject_alloc.suballoccourseid and subject_alloc.staff_id = staff.staff_id and suballocatecourse.course_id = '"+str(session['course_id'])+"' and suballocatecourse.sems = '"+str(session['sem'])+"'")
            v={}
            if len(res)>0:
                v["status"]="ok"
                v['data']=res
...
def staffsview(aid):
    db = Db()
    res = db.selectOne("select * from subject_alloc,staff where  subject_alloc.staff_id = staff.staff_id and subject_alloc.suballoccourseid='"+aid+"'")
...
def view_exmnotification():
    if session['lg'] == "lin":
        db = Db()
        res = db.select("select * from subject,suballocatecourse,subject_alloc,course,staff,exam where exam.subject_alloc_id=subject_alloc.suballoc_courseid and staff.Staff_id=subject_alloc.staff_id  and course.course_id=suballocatecourse.course_id and suballocatecourse.subject_id=subject.sub_id and subject_alloc.suballoccourseid=suballocatecourse.suballoc_courseid and suballocatecourse.course_id= '"+str(session['course_id'])+"' and sems='"+str(session['sem'])+"'")
        d = datetime.datetime.now().strftime("%Y-%m-%d")
        q=[]
        for i in res:
            qq=db.selectOne("select * from result where examid='"+str(i['exam_id'])+"' and studid='"+str(session['lid'])+"'")
            if qq is None:
                q.append({'sub_name':i['sub_name'],'date':i['date'],'time':i['time'],'eid':i['exam_id'],'status':'pending','marks':i['marks']})
            else:
                q.append({'sub_name':i['sub_name'],'date':i['date'],'time':i['time'],'eid':i['exam_id'],'status':'attended','marks':i['marks']})
    ...
    if session['lg'] == "lin":
        ...
        if request.method=="POST":
            ...
            if session['cnt']<len(res):
                ...
                studid=session['lid']
                db=Db()
                res=db.selectOne("select * from result where studid='"+ str(studid)+"' and examid='"+ examid +"'")
                if res is None:
                    db=Db()
                    db.insert("insert into result values(null, '"+ examid +"', '"+ str(studid) +"', '"+ str(score) +"')")
                else :
                    db=Db()
                    db.update("UPDATE  result set mark='"+ str(score) +"' where examid='"+ examid +"' and studid='"+ str(studid)+"'")
...
def view_result(eid,m):
    db=Db()
    if session['lg'] == "lin":
        res=db.selectOne("select result.mark from result where studid='"+ str(session['lid'])+"' and examid ='"+ str(eid)+"' ")
